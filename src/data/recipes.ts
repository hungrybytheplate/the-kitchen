...
export const sampleRecipes: Recipe[] = [
  ...
  },
  {
    ...
    mealType: "dessert",
    description: "Tender, moist vanilla cake made with the reverse creaming method for extra-fine crumb",
    cookTime: "50 min",
    servings: 16,
    ingredients: ["flour", "sugar-white", "butter", "eggs", "milk", "vanilla-extract", "baking-powder", "sour-cream", "powdered-sugar"],
    instructions: [
      "Preheat oven to 325°F. Grease two 9-inch round pans, line with parchment, grease again and lightly flour.",
      "REVERSE CREAMING METHOD: Whisk 2¾ cups cake flour (or 2½ cups all-purpose), 1¾ cups sugar, 1 tablespoon baking powder, ¾ teaspoon salt in mixer bowl.",
      "Add 1 cup (2 sticks) room-temp butter, cut into pieces. Mix on low until mixture resembles coarse sand, about 2 minutes.",
      "In separate bowl, whisk ¾ cup milk, ½ cup sour cream, 4 egg whites, 1 tablespoon vanilla bean paste (or 2 teaspoons extract).",
      "Add half the wet mixture to flour mixture. Beat on medium 2 minutes until smooth and fluffy. Scrape bowl. Add remaining wet mixture, beat 30 seconds.",
      "Divide evenly between pans. Bake 28-32 minutes until toothpick comes out with few moist crumbs. Cool 10 minutes in pan, then turn out onto wire rack.",
      "SWISS MERINGUE BUTTERCREAM: In heatproof bowl over simmering water, whisk 5 egg whites + 1½ cups sugar until sugar dissolves and mixture reaches 160°F.",
      "Transfer to mixer, beat on high until stiff, glossy peaks form and bowl is cool to touch, 8-10 minutes.",
      "Add 1½ cups (3 sticks) soft butter, 2 tablespoons at a time, beating after each. Add 2 teaspoons vanilla, pinch of salt. Beat until silky smooth.",
      "Level cake layers if needed. Place one layer on stand, spread with 1 cup frosting. Add second layer, crumb coat entire cake with thin layer of frosting. Chill 20 minutes.",
      "Apply final coat of frosting, smoothing with offset spatula or bench scraper. Decorate as desired."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "medium",
    nutrition: { calories: 385, protein: 5, carbs: 48, fat: 20 },
    cuisine: "american",
  },
  {
    id: "chocolate-cake",
