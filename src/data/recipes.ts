...
export const sampleRecipes: Recipe[] = [
  ...
  },
  {
    ...
    cookTime: "45 min",
    servings: 6,
    ingredients: ["ground-beef", "ground-pork", "onion", "bread", "eggs", "cream", "butter", "allspice", "nutmeg"],
    instructions: [
      "Soak 2 slices bread in ¼ cup milk. Mash to paste.",
      "Mix ½ lb ground beef, ½ lb ground pork, bread paste, 1 beaten egg, ¼ cup minced sautéed onion, ¼ tsp allspice, pinch nutmeg, salt.",
      "Roll into 1-inch balls. Brown in butter on all sides. Remove and set aside.",
      "In same pan, make roux with 3 tbsp butter and 3 tbsp flour. Cook 2 minutes.",
      "Whisk in 1 cup beef broth, 1 cup cream. Simmer until thickened.",
      "Return meatballs to sauce. Simmer 15 minutes. Serve over egg noodles with lingonberry jam."
    ],
    matchedIngredients: [],
    difficulty: "medium",
    nutrition: { calories: 485, protein: 24, carbs: 18, fat: 36 },
    cuisine: "comfort",
  },
