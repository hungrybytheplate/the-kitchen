...
export const sampleRecipes: Recipe[] = [
  ...
  },
  {
    ...
    cookTime: "10 min",
    servings: 4,
    ingredients: ["milk", "cream", "chocolate-syrup", "vanilla", "sugar", "cocoa-powder"],
    ingredientAmounts: [
      { id: "milk", amount: "2", unit: "cups" },
      { id: "cream", amount: "0.75", unit: "cup heavy cream" },
      { id: "chocolate-syrup", amount: "0.33", unit: "cup" },
      { id: "vanilla", amount: "1", unit: "tsp" },
      { id: "sugar", amount: "0.25", unit: "cup" },
      { id: "cocoa-powder", amount: "2", unit: "tbsp" },
    ],
    keyIngredients: ["milk", "chocolate-syrup"],
    instructions: [
      "Combine milk, heavy cream, chocolate syrup, vanilla, sugar, and cocoa powder in a blender.",
      ...
      "Serve immediately in a cup with a spoon. Perfect for dipping fries! Store any extra in freezer for up to 2 weeks."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "easy",
    cuisine: "american",
    nutrition: { calories: 280, protein: 6, carbs: 38, fat: 12, sodium: 140, cholesterol: 45 },
  },
  {
