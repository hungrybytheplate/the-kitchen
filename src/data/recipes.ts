...
export const sampleRecipes: Recipe[] = [
...

  {
    ...
    instructions: [
      "ACTIVATE YEAST: Warm 1½ cups water to 110°F. Stir in 1 tbsp sugar and the yeast. Let sit 5–10 minutes until foamy.",
      "MAKE DOUGH: In a large bowl, combine bread flour, remaining 2 tbsp sugar, and salt. Pour in the yeast mixture and melted butter. Stir until a shaggy dough forms.",
      "KNEAD: Turn dough onto a lightly floured surface and knead 10–12 minutes until very smooth, elastic, and slightly tacky. The dough should be stiffer than regular bread dough — this is what creates the chew.",
      "FIRST RISE: Place dough in a lightly oiled bowl, cover with plastic wrap or a damp towel. Let rise in a warm spot for 1 hour, or until doubled in size.",
      "SHAPE: Punch down the dough and divide into 8 equal pieces (about 4 oz each). Roll each piece into a smooth ball. Poke a hole through the center with your thumb and stretch to about 2 inches wide. Place shaped bagels on a parchment-lined baking sheet.",
      "REST: Cover shaped bagels loosely with a towel and let rest 20 minutes. They should puff slightly. Meanwhile, preheat oven to 425°F.",
      "BOIL: Bring a large pot of water to a rolling boil. Add 1 tbsp sugar (or honey/malt syrup for deeper flavor). Boil bagels 2 at a time: 1 minute per side. Remove with a slotted spoon to a wire rack.",
      "TOP (OPTIONAL): While still wet, dip tops into everything seasoning, sesame seeds, poppy seeds, dried onion flakes, or coarse salt.",
      "EGG WASH: Beat 1 egg with 1 tbsp water. Brush the tops of each boiled bagel with egg wash for a glossy, golden crust.",
      "BAKE: Place bagels on a parchment-lined baking sheet. Bake at 425°F for 20–25 minutes, rotating the pan halfway through, until deep golden brown.",
      "COOL: Let bagels cool on a wire rack at least 15 minutes before slicing. They'll firm up as they cool.",
      "STORE: Keep in an airtight bag at room temperature for 2 days, or slice and freeze for up to 3 months. Toast from frozen.",
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "medium",
    nutrition: { calories: 280, protein: 9, carbs: 52, fat: 4, fiber: 2 },
    cuisine: "american",
    suggestedSides: [
      { name: "Homemade Cream Cheese Spread", description: "Classic schmear on a fresh warm bagel" },
      { name: "Fluffy Scrambled Eggs on Toast", description: "Pile fluffy eggs on a toasted bagel half" },
      { name: "Fresh Fruit Parfait", description: "Light yogurt parfait alongside a hearty bagel" },
    ],
  },

  {
    id: "2-ingredient-bagels",
    title: "2-Ingredient Bagels",
    mealType: "breakfast",
    ...
    instructions: [
      "MAKE SELF-RISING FLOUR (if needed): If you don't have self-rising flour, whisk together 1½ cups all-purpose flour, 2 tsp baking powder, and ¼ tsp salt.",
      "PREHEAT: Preheat oven to 375°F. Line a baking sheet with parchment paper.",
      "MIX DOUGH: In a medium bowl, combine the self-rising flour and Greek yogurt. Stir with a fork until a shaggy dough forms, then use your hands to bring it together into a ball. The dough will be sticky — that's normal.",
      "FLOUR YOUR SURFACE: Dust a clean surface generously with flour. Turn out the dough and knead gently 15–20 times until smooth. Don't over-knead or the bagels will be tough.",
      "DIVIDE: Cut the dough into 4 equal pieces.",
      "SHAPE: Roll each piece into a rope about 7 inches long. Wrap it into a circle and press the ends together firmly, pinching to seal. Alternatively, shape into a ball and poke a hole through the center, stretching to about 1.5 inches wide.",
      "EGG WASH (OPTIONAL): Beat 1 egg white with 1 tsp water and brush the tops for a shinier crust.",
      "TOP (OPTIONAL): Sprinkle tops with everything seasoning, sesame seeds, poppy seeds, or coarse salt while the wash is still wet.",
      "BAKE: Place bagels on the prepared baking sheet. Bake at 375°F for 22–25 minutes, until golden brown on top and firm to the touch.",
      "COOL: Let cool 5 minutes on the pan, then transfer to a wire rack.",
      "SERVE: Slice in half and toast for extra crispness. Top with cream cheese, butter, avocado, or your favorite spread.",
      "STORE: Keep in an airtight container at room temperature for 1–2 days, or freeze for up to 2 months.",
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "high-protein"],
    difficulty: "easy",
    nutrition: { calories: 195, protein: 10, carbs: 34, fat: 2, fiber: 1 },
    cuisine: "american",
    suggestedSides: [
      { name: "Homemade Cream Cheese Spread", description: "A classic schmear on a warm easy bagel" },
      { name: "Loaded Veggie Egg Scramble", description: "Pile scrambled eggs and veggies on a toasted bagel" },
      { name: "Berry Blast Smoothie", description: "Quick berry smoothie pairs perfectly with a fast bagel" },
    ],
  },
  ...
  },
  {
    ...
    title: "Crispy Copycat Chicken Nuggets",
    mealType: "lunch",
  ...
  },
  {
    ...
    ingredientAmounts: [
      ...
      { id: "garlic", amount: "3", unit: "cloves" },
      { id: "ginger", amount: "1", unit: "tbsp fresh grated" },
      { id: "soy-sauce", amount: "2", unit: "tbsp" },
      { id: "sesame-oil", amount: "1", unit: "tbsp" },
      { id: "flour-all-purpose", amount: "3", unit: "cups" },
      { id: "eggs", amount: "1", unit: "large" },
      { id: "salt", amount: "1", unit: "tsp" },
      { id: "pepper", amount: "0.5", unit: "tsp" },
      { id: "vegetable-oil", amount: "2", unit: "tbsp" },
    ...
    instructions: [
      ...
      "Turn dough onto a lightly floured surface and knead for 8-10 minutes until smooth, elastic, and springs back when poked. If dough is sticky, add flour 1 tablespoon at a time. If too dry, wet your hands lightly.",
      "Shape dough into a ball, cover tightly with plastic wrap or a damp towel, and rest at room temperature for 30 minutes. This relaxes the gluten and makes rolling easy.",
      "MAKE THE FILLING: While dough rests, finely chop 2 cups green cabbage. Sprinkle with ½ teaspoon salt, toss, and let sit 10 minutes. Squeeze out as much liquid as possible using a clean towel — this prevents soggy dumplings.",
      "In a large bowl, combine 1 lb ground pork, squeezed cabbage, 4 thinly sliced green onions, 3 minced garlic cloves, 1 tablespoon grated fresh ginger, 2 tablespoons soy sauce, 1 tablespoon sesame oil, and ¼ teaspoon pepper. Mix in one direction (clockwise) for 2 minutes until the filling is sticky and cohesive.",
      "ROLL THE WRAPPERS: Divide rested dough in half. Roll each half into a long rope about 1 inch in diameter. Cut each rope into 20 pieces (40 total). Keep cut pieces covered with a damp towel.",
      "Flatten each piece into a disc with your palm, then roll with a small rolling pin into a 3.5-inch circle, rotating as you roll. Keep the center slightly thicker than the edges — this prevents the bottom from tearing.",
      "FOLD THE DUMPLINGS (Pleated Crescent): Place 1 heaping teaspoon of filling in the center of a wrapper. Fold the wrapper in half to form a half-moon. Pinch the center to seal.",
      "Starting from the center, make 3-4 small pleats on the front side of the wrapper toward the right edge, pressing each pleat against the smooth back side. Repeat on the left side. The dumpling should curve into a crescent with pleats all facing the front.",
      "Place each finished dumpling on a parchment-lined tray. Don't let dumplings touch each other or they'll stick. Cover with a damp towel as you work.",
      "TO PAN-FRY (Potstickers): Heat 1 tablespoon vegetable oil in a large non-stick skillet over medium-high heat. Place dumplings flat-side down in a single layer, not touching. Cook 2-3 minutes until bottoms are golden brown.",
      "Without moving the dumplings, carefully pour ¼ cup water into the skillet. Immediately cover with a tight-fitting lid. Reduce heat to medium and steam for 6-7 minutes until water evaporates and you hear sizzling again.",
      "Remove lid and cook 1 more minute to re-crisp the bottoms. The dumplings should release easily — if not, they need 30 more seconds. Serve crispy-side up.",
      "TO STEAM: Line a bamboo steamer or metal steamer basket with parchment paper (poke small holes) or cabbage leaves. Place dumplings 1 inch apart. Steam over boiling water with lid on for 10-12 minutes until wrappers are translucent and filling is cooked through.",
      "TO BOIL: Bring a large pot of water to a rolling boil. Add dumplings gently, stir once to prevent sticking. When water returns to a boil, add ½ cup cold water. Repeat 2 more times (3 cold water additions total). Dumplings are done when they float and the skins look translucent, about 8-10 minutes total.",
      "DIPPING SAUCE: Mix 3 tablespoons soy sauce, 1 tablespoon rice vinegar, 1 teaspoon sesame oil, and a pinch of chili flakes. Add sliced green onion for garnish.",
      "TO FREEZE: Place uncooked dumplings on a parchment-lined baking sheet, not touching. Freeze 2 hours until solid, then transfer to a freezer bag. Cook from frozen — add 2-3 extra minutes to any cooking method. Do not thaw first.",
    ],
    matchedIngredients: [],
    dietaryTags: ["dairy-free"],
    difficulty: "hard",
    nutrition: { calories: 45, protein: 3, carbs: 5, fat: 2 },
    cuisine: "asian",
    customizeSpices: "Add chili oil, black vinegar, or five-spice powder for authentic flavor variations",
  },
  ...
  // ============ HEART HEALTHY ============
  {
    id: "heart-healthy-salmon-quinoa",
    ...
    instructions: [
      ...
      "Season salmon fillets with olive oil, minced garlic, lemon zest, salt, and pepper.",
      "Heat a grill pan over medium-high heat. Cook salmon skin-side down for 4-5 minutes per side until internal temp reaches 145°F.",
      "Toss cooked quinoa with fresh spinach, halved cherry tomatoes, a squeeze of lemon juice, and a drizzle of olive oil.",
      "Serve salmon over the quinoa mixture. Garnish with fresh dill and lemon wedges."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein"],
    difficulty: "easy",
    nutrition: { calories: 420, protein: 38, carbs: 32, fat: 16, fiber: 5, sodium: 180, cholesterol: 65 },
    cuisine: "mediterranean",
    heartHealthy: true,
  },
  {
    id: "heart-healthy-oat-berry-bowl",
    title: "Steel-Cut Oat & Berry Power Bowl",
    mealType: "breakfast",
    description: "Fiber-rich steel-cut oats with antioxidant berries, walnuts, and flax seeds",
    cookTime: "20 min",
    servings: 2,
    ingredients: ["oats", "berries", "walnuts", "flax-seeds", "honey", "cinnamon", "almond-milk"],
    ingredientAmounts: [
      { id: "oats", amount: "1", unit: "cup" },
      { id: "berries", amount: "1", unit: "cup" },
      { id: "walnuts", amount: "0.25", unit: "cup" },
      { id: "flax-seeds", amount: "2", unit: "tbsp" },
      { id: "honey", amount: "1", unit: "tbsp" },
      { id: "cinnamon", amount: "1", unit: "tsp" },
      { id: "almond-milk", amount: "2.5", unit: "cups" },
    ],
    instructions: [
      "Bring 2.5 cups almond milk to a boil in a medium saucepan.",
      "Add 1 cup steel-cut oats and reduce heat to low. Simmer 15-18 minutes, stirring occasionally.",
      "Stir in cinnamon and ground flax seeds during the last 2 minutes of cooking.",
      "Divide into bowls and top with fresh berries, chopped walnuts, and a light drizzle of honey.",
      "Serve warm. The fiber and omega-3s from walnuts and flax support heart health."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 310, protein: 10, carbs: 45, fat: 12, fiber: 8, sodium: 45, cholesterol: 0 },
    heartHealthy: true,
  },
  {
    id: "heart-healthy-chicken-veggie-stir-fry",
    title: "Heart-Healthy Chicken & Vegetable Stir-Fry",
    mealType: "dinner",
    ...
    ingredientAmounts: [
      ...
      { id: "bell-pepper", amount: "2", unit: "medium" },
      { id: "carrots", amount: "2", unit: "medium" },
      { id: "garlic", amount: "4", unit: "cloves" },
      { id: "ginger", amount: "1", unit: "tbsp" },
      { id: "sesame-oil", amount: "1", unit: "tbsp" },
      { id: "rice", amount: "2", unit: "cups" },
    ...
    instructions: [
      ...
      "Slice chicken breast into thin strips. Season with a pinch of salt and pepper.",
      "Heat sesame oil in a wok over high heat. Stir-fry chicken 4-5 minutes until cooked through. Remove and set aside.",
      "Add broccoli florets, sliced bell peppers, and julienned carrots. Stir-fry 3-4 minutes until crisp-tender.",
      "Add minced garlic and grated ginger. Cook 30 seconds until fragrant.",
      "Return chicken to wok. Toss everything together. Serve over brown rice."
    ],
    matchedIngredients: [],
    dietaryTags: ["high-protein", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 380, protein: 32, carbs: 42, fat: 8, fiber: 5, sodium: 220, cholesterol: 70 },
    cuisine: "asian",
    heartHealthy: true,
  },
  {
    id: "heart-healthy-mediterranean-lentil-soup",
    title: "Mediterranean Lentil & Vegetable Soup",
    mealType: "lunch",
    ...
    ingredientAmounts: [
      ...
      { id: "tomatoes", amount: "1", unit: "can (14 oz)" },
      { id: "onion", amount: "1", unit: "large" },
      { id: "garlic", amount: "4", unit: "cloves" },
      { id: "carrots", amount: "2", unit: "medium" },
      { id: "celery", amount: "2", unit: "stalks" },
    ...
    instructions: [
      ...
      "Add minced garlic and cumin. Cook 1 minute until fragrant.",
      "Add rinsed lentils, diced tomatoes, and 6 cups water or low-sodium broth.",
      "Bring to a boil, reduce heat, and simmer 25 minutes until lentils are tender.",
      "Stir in chopped kale during the last 5 minutes. Season with pepper and a squeeze of lemon.",
      "Serve hot. This soup is packed with soluble fiber that helps lower cholesterol."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "high-fiber", "low-sodium"],
    difficulty: "easy",
    nutrition: { calories: 260, protein: 16, carbs: 40, fat: 5, fiber: 12, sodium: 120, cholesterol: 0 },
    cuisine: "mediterranean",
    heartHealthy: true,
  },
  {
    id: "heart-healthy-avocado-tuna-wrap",
    title: "Avocado & Tuna Lettuce Wraps",
    mealType: "lunch",
    ...
    ingredientAmounts: [
      ...
      { id: "avocado", amount: "1", unit: "medium" },
      { id: "lettuce", amount: "8", unit: "large leaves" },
      { id: "cucumber", amount: "1", unit: "medium" },
    ...
    instructions: [
      ...
      "Dice avocado and cucumber. Finely mince red onion.",
      "Combine tuna, avocado, cucumber, and red onion. Drizzle with olive oil and lemon juice.",
      "Season with black pepper. Gently toss to combine without mashing the avocado.",
      "Spoon mixture into crisp lettuce cups. Serve immediately."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein", "low-carb"],
    difficulty: "easy",
    nutrition: { calories: 290, protein: 30, carbs: 12, fat: 16, fiber: 6, sodium: 160, cholesterol: 45 },
    heartHealthy: true,
  },
  {
    id: "heart-healthy-baked-chicken-sweet-potato",
    title: "Herb-Baked Chicken with Roasted Sweet Potato",
    mealType: "dinner",
    ...
    ingredientAmounts: [
      ...
      { id: "green-beans", amount: "2", unit: "cups" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
    ...
    instructions: [
      ...
      "Cube sweet potatoes. Toss with 1 tbsp olive oil and spread on the pan. Roast 15 minutes.",
      "Season chicken breasts with rosemary, thyme, minced garlic, remaining olive oil, and pepper.",
      "Add chicken and green beans to the pan with sweet potatoes. Return to oven for 22-25 minutes.",
      "Chicken is done when internal temp reaches 165°F. Let rest 5 minutes before slicing.",
      "Plate with roasted sweet potatoes and green beans. A balanced, heart-healthy complete meal."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein"],
    difficulty: "easy",
    nutrition: { calories: 360, protein: 35, carbs: 30, fat: 10, fiber: 5, sodium: 190, cholesterol: 80 },
    heartHealthy: true,
  },
  {
    id: "heart-healthy-walnut-banana-smoothie-bowl",
    title: "Walnut Banana Smoothie Bowl",
    mealType: "breakfast",
    description: "Creamy banana base topped with heart-healthy walnuts, berries, and chia seeds",
    cookTime: "5 min",
    servings: 1,
    ingredients: ["banana", "walnuts", "berries", "chia-seeds", "almond-milk", "honey"],
    ingredientAmounts: [
      { id: "banana", amount: "2", unit: "frozen" },
      { id: "walnuts", amount: "2", unit: "tbsp" },
      { id: "berries", amount: "0.5", unit: "cup" },
      { id: "chia-seeds", amount: "1", unit: "tbsp" },
      { id: "almond-milk", amount: "0.5", unit: "cup" },
      { id: "honey", amount: "1", unit: "tsp" },
    ],
    instructions: [
      "Blend frozen bananas with almond milk until thick and creamy (like soft serve).",
      "Pour into a bowl. Top with berries, chopped walnuts, and chia seeds.",
      "Drizzle with a touch of honey. Enjoy immediately."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 320, protein: 7, carbs: 52, fat: 12, fiber: 9, sodium: 30, cholesterol: 0 },
    heartHealthy: true,
  },
  {
    id: "heart-healthy-grilled-veggie-hummus-wrap",
    title: "Grilled Vegetable & Hummus Wrap",
    mealType: "lunch",
    description: "Whole wheat wrap loaded with grilled vegetables and fiber-rich hummus",
    cookTime: "15 min",
    servings: 2,
    ingredients: ["tortilla", "hummus", "zucchini", "bell-pepper", "red-onion", "spinach", "olive-oil"],
    ingredientAmounts: [
      { id: "tortilla", amount: "2", unit: "whole wheat" },
      { id: "hummus", amount: "0.5", unit: "cup" },
      { id: "zucchini", amount: "1", unit: "medium" },
      { id: "bell-pepper", amount: "1", unit: "large" },
      { id: "red-onion", amount: "0.5", unit: "medium" },
      { id: "spinach", amount: "1", unit: "cup" },
      { id: "olive-oil", amount: "1", unit: "tbsp" },
    ],
    instructions: [
      "Slice zucchini, bell pepper, and red onion into strips. Toss with olive oil and pepper.",
      "Grill vegetables on a grill pan over medium-high heat for 3-4 minutes per side.",
      "Warm whole wheat tortillas in a dry pan for 30 seconds each side.",
      "Spread hummus generously on each wrap. Layer with spinach and grilled vegetables.",
      "Roll tightly, cut in half diagonally, and serve."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 300, protein: 10, carbs: 38, fat: 12, fiber: 7, sodium: 280, cholesterol: 0 },
    cuisine: "mediterranean",
    heartHealthy: true,
  },
  {
    id: "heart-healthy-black-bean-sweet-potato-chili",
    ...
    ingredientAmounts: [
      ...
      { id: "tomatoes", amount: "1", unit: "can (28 oz)" },
      { id: "onion", amount: "1", unit: "large" },
      { id: "garlic", amount: "4", unit: "cloves" },
      { id: "cumin", amount: "2", unit: "tsp" },
      { id: "chili-powder", amount: "1", unit: "tbsp" },
    ...
    instructions: [
      ...
      "Add minced garlic, cumin, and chili powder. Cook 1 minute.",
      "Add diced sweet potatoes, crushed tomatoes, drained black beans, and 1 cup water.",
      "Bring to a boil, then reduce heat and simmer 25-30 minutes until sweet potatoes are tender.",
      "Mash a few sweet potato pieces to thicken. Season with pepper.",
      "Serve in bowls. Top with avocado slices or a dollop of Greek yogurt if desired."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "high-fiber", "low-sodium"],
    difficulty: "easy",
    nutrition: { calories: 280, protein: 12, carbs: 48, fat: 4, fiber: 14, sodium: 140, cholesterol: 0 },
    heartHealthy: true,
  },
  {
    id: "heart-healthy-baked-cod-tomato-olive",
    ...
    ingredientAmounts: [
      ...
      { id: "olives", amount: "0.25", unit: "cup" },
      { id: "capers", amount: "1", unit: "tbsp" },
      { id: "garlic", amount: "3", unit: "cloves" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
      { id: "basil", amount: "0.25", unit: "cup" },
    ],
    instructions: [
      ...
      "Arrange cod fillets in a baking dish. Season with pepper and a drizzle of olive oil.",
      "Scatter halved cherry tomatoes, sliced olives, capers, and sliced garlic around the fish.",
      "Bake 18-20 minutes until cod flakes easily with a fork.",
      "Garnish with fresh basil leaves. Serve with a side of steamed asparagus or brown rice."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein", "low-carb"],
    difficulty: "easy",
    nutrition: { calories: 240, protein: 30, carbs: 8, fat: 10, fiber: 2, sodium: 320, cholesterol: 55 },
    cuisine: "mediterranean",
    heartHealthy: true,
  },
  // ============ ANTI-INFLAMMATORY RECIPES ============
  {
    id: "anti-inflam-turmeric-chicken",
    title: "Turmeric Ginger Chicken",
    mealType: "dinner",
    description: "Anti-inflammatory chicken thighs braised in a golden turmeric-ginger sauce with warming spices",
    cookTime: "35 min",
    servings: 4,
    ingredients: ["chicken-thighs", "turmeric", "ginger-fresh", "garlic", "coconut-milk", "onion", "olive-oil", "salt", "pepper", "cumin"],
    ingredientAmounts: [
      { id: "chicken-thighs", amount: "1.5", unit: "lbs" },
      { id: "turmeric", amount: "1", unit: "tbsp" },
      { id: "ginger-fresh", amount: "2", unit: "tbsp grated" },
      { id: "garlic", amount: "4", unit: "cloves" },
      { id: "coconut-milk", amount: "1", unit: "can (14 oz)" },
      { id: "onion", amount: "1", unit: "medium" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
      { id: "salt", amount: "1", unit: "tsp" },
      { id: "pepper", amount: "0.5", unit: "tsp" },
    ...
    instructions: [
      "Pat chicken thighs dry and season with turmeric, cumin, salt, and pepper.",
      "Heat olive oil in a large skillet over medium-high heat. Sear chicken 4 minutes per side until golden. Remove and set aside.",
      "In the same pan, sauté diced onion for 3 minutes until softened.",
      "Add minced garlic and grated ginger, cook 1 minute until fragrant.",
      "Pour in coconut milk and stir to combine, scraping up browned bits.",
      "Return chicken to the pan. Cover and simmer 18-20 minutes until chicken reaches 165°F.",
      "Serve over rice or cauliflower rice with extra sauce spooned on top."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 380, protein: 32, carbs: 10, fat: 24, fiber: 2, sodium: 350, cholesterol: 130 },
    cuisine: "indian",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-salmon-bowl",
    title: "Anti-Inflammatory Salmon Power Bowl",
    mealType: "lunch",
    description: "Omega-3 rich salmon over quinoa with avocado, spinach, and a lemon-tahini drizzle",
    cookTime: "25 min",
    servings: 2,
    ingredients: ["salmon", "quinoa-white", "avocado", "spinach", "lemon", "tahini", "olive-oil", "garlic", "salt", "pepper"],
    ingredientAmounts: [
      { id: "salmon", amount: "2", unit: "fillets (6 oz each)" },
      { id: "quinoa-white", amount: "1", unit: "cup" },
      { id: "avocado", amount: "1", unit: "medium" },
      { id: "spinach", amount: "2", unit: "cups" },
      { id: "lemon", amount: "1", unit: "whole" },
      { id: "tahini", amount: "2", unit: "tbsp" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
      { id: "garlic", amount: "1", unit: "clove" },
      { id: "salt", amount: "0.5", unit: "tsp" },
      { id: "pepper", amount: "0.25", unit: "tsp" },
    ...
    instructions: [
      ...
      "Season salmon with olive oil, salt, and pepper. Bake at 400°F for 12-14 minutes until flaky.",
      "Whisk tahini with lemon juice, minced garlic, and 2 tbsp water for the dressing.",
      "Divide quinoa into bowls. Top with fresh spinach, flaked salmon, and sliced avocado.",
      "Drizzle generously with lemon-tahini dressing. The omega-3s from salmon and healthy fats from avocado are powerful anti-inflammatories."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein"],
    difficulty: "easy",
    nutrition: { calories: 520, protein: 38, carbs: 35, fat: 26, fiber: 8, sodium: 280, cholesterol: 70 },
    cuisine: "healthy",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-berry-oats",
    title: "Anti-Inflammatory Berry Turmeric Oatmeal",
    mealType: "breakfast",
    description: "Warming oatmeal with blueberries, walnuts, turmeric, and cinnamon — a perfect anti-inflammatory start",
    cookTime: "10 min",
    servings: 2,
    ingredients: ["oats-rolled", "blueberries", "walnuts", "turmeric", "cinnamon", "honey", "almond-milk"],
    ingredientAmounts: [
      { id: "oats-rolled", amount: "1", unit: "cup" },
      { id: "blueberries", amount: "1", unit: "cup" },
      { id: "walnuts", amount: "0.25", unit: "cup chopped" },
      { id: "turmeric", amount: "0.5", unit: "tsp" },
      { id: "cinnamon", amount: "0.5", unit: "tsp" },
      { id: "honey", amount: "1", unit: "tbsp" },
      { id: "almond-milk", amount: "2", unit: "cups" },
    ],
    instructions: [
      "Bring almond milk to a simmer in a small saucepan.",
      "Stir in rolled oats, turmeric, and cinnamon. Cook 5 minutes, stirring occasionally.",
      "Remove from heat, top with blueberries, chopped walnuts, and a drizzle of honey.",
      "Blueberries are packed with anthocyanins — one of nature's most powerful anti-inflammatory compounds."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 320, protein: 10, carbs: 48, fat: 12, fiber: 7, sodium: 40, cholesterol: 0 },
    cuisine: "healthy",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-ginger-lentil-soup",
    ...
    ingredientAmounts: [
      ...
      { id: "onion", amount: "1", unit: "medium" },
      { id: "coconut-milk", amount: "0.5", unit: "cup" },
      { id: "vegetable-broth", amount: "4", unit: "cups" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
      { id: "cumin", amount: "1", unit: "tsp" },
      { id: "salt", amount: "1", unit: "tsp" },
    ],
    instructions: [
      ...
      "Add garlic, ginger, turmeric, and cumin. Cook 1 minute until very fragrant.",
      "Add rinsed red lentils and vegetable broth. Bring to a boil.",
      "Reduce heat, cover, and simmer 20 minutes until lentils are completely soft.",
      "Stir in coconut milk. Use an immersion blender for a creamy texture, or leave chunky.",
      "Season with salt. Turmeric paired with black pepper increases curcumin absorption by 2000%."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 280, protein: 16, carbs: 38, fat: 8, fiber: 12, sodium: 320, cholesterol: 0 },
    cuisine: "indian",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-walnut-crusted-salmon",
    title: "Walnut-Crusted Baked Salmon",
    mealType: "dinner",
    ...
    ingredientAmounts: [
      ...
      { id: "lemon", amount: "1", unit: "zested and juiced" },
      { id: "garlic", amount: "2", unit: "cloves minced" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
    ...
    instructions: [
      "Preheat oven to 400°F. Line a baking sheet with parchment paper.",
      "Mix chopped walnuts, minced garlic, parsley, lemon zest, and olive oil in a bowl.",
      "Place salmon fillets skin-side down. Season with salt and pepper.",
      "Press the walnut mixture firmly onto the top of each fillet.",
      "Bake 14-16 minutes until salmon flakes easily and walnut crust is golden.",
      "Squeeze fresh lemon juice over the top before serving. Omega-3 fatty acids from both salmon and walnuts deliver potent anti-inflammatory benefits."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free", "high-protein", "paleo"],
    difficulty: "easy",
    nutrition: { calories: 420, protein: 38, carbs: 4, fat: 28, fiber: 2, sodium: 280, cholesterol: 85 },
    cuisine: "mediterranean",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-sweet-potato-curry",
    title: "Sweet Potato & Chickpea Turmeric Curry",
    mealType: "dinner",
    description: "Warming vegan curry packed with anti-inflammatory turmeric, sweet potatoes, and chickpeas",
    cookTime: "35 min",
    servings: 4,
    ingredients: ["sweet-potato", "chickpeas", "turmeric", "ginger-fresh", "garlic", "coconut-milk", "onion", "tomato-sauce", "cumin", "olive-oil", "salt"],
    ingredientAmounts: [
      { id: "sweet-potato", amount: "2", unit: "large, cubed" },
      { id: "chickpeas", amount: "1", unit: "can (15 oz)" },
      { id: "turmeric", amount: "1", unit: "tbsp" },
      { id: "ginger-fresh", amount: "1", unit: "tbsp grated" },
      { id: "garlic", amount: "3", unit: "cloves" },
      { id: "coconut-milk", amount: "1", unit: "can (14 oz)" },
      { id: "onion", amount: "1", unit: "medium" },
      { id: "tomato-sauce", amount: "0.5", unit: "cup" },
      { id: "cumin", amount: "1", unit: "tsp" },
      { id: "olive-oil", amount: "2", unit: "tbsp" },
      { id: "salt", amount: "1", unit: "tsp" },
    ],
    instructions: [
      "Heat olive oil in a large pot. Sauté diced onion 4 minutes.",
      "Add garlic, ginger, turmeric, and cumin. Cook 1 minute.",
      "Add cubed sweet potatoes and stir to coat in spices.",
      "Pour in coconut milk, tomato sauce, and drained chickpeas.",
      "Bring to a boil, reduce heat, and simmer 25 minutes until sweet potatoes are fork-tender.",
      "Season with salt. Serve over rice or with naan bread."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free", "high-fiber"],
    difficulty: "easy",
    nutrition: { calories: 360, protein: 12, carbs: 45, fat: 16, fiber: 10, sodium: 380, cholesterol: 0 },
    cuisine: "indian",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-green-smoothie-bowl",
    title: "Green Anti-Inflammatory Smoothie Bowl",
    mealType: "breakfast",
    description: "Vibrant spinach and pineapple smoothie bowl with anti-inflammatory ginger and turmeric",
    cookTime: "5 min",
    servings: 1,
    ingredients: ["spinach", "pineapple", "banana", "ginger-fresh", "turmeric", "almond-milk", "chia-seeds", "honey"],
    ingredientAmounts: [
      { id: "spinach", amount: "2", unit: "cups" },
      { id: "pineapple", amount: "1", unit: "cup frozen" },
      { id: "banana", amount: "1", unit: "frozen" },
      { id: "ginger-fresh", amount: "0.5", unit: "inch knob" },
      { id: "turmeric", amount: "0.5", unit: "tsp" },
      { id: "almond-milk", amount: "0.75", unit: "cup" },
      { id: "chia-seeds", amount: "1", unit: "tbsp" },
      { id: "honey", amount: "1", unit: "tsp" },
    ],
    instructions: [
      "Blend spinach, frozen pineapple, frozen banana, ginger, turmeric, and almond milk until thick and creamy.",
      "Pour into a bowl — it should be thick enough to eat with a spoon.",
      "Top with chia seeds, extra fruit, and a drizzle of honey.",
      "Bromelain from pineapple is a natural anti-inflammatory enzyme that aids digestion."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 280, protein: 6, carbs: 52, fat: 6, fiber: 8, sodium: 60, cholesterol: 0 },
    cuisine: "healthy",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-cauliflower-soup",
    title: "Roasted Cauliflower & Turmeric Soup",
    mealType: "lunch",
    description: "Silky roasted cauliflower soup with golden turmeric and garlic — deeply nourishing and anti-inflammatory",
    cookTime: "40 min",
    servings: 4,
    ingredients: ["cauliflower", "turmeric", "garlic", "onion", "vegetable-broth", "olive-oil", "coconut-milk", "salt", "pepper"],
    ingredientAmounts: [
      { id: "cauliflower", amount: "1", unit: "large head" },
      { id: "turmeric", amount: "1", unit: "tsp" },
      { id: "garlic", amount: "4", unit: "cloves" },
      { id: "onion", amount: "1", unit: "medium" },
      { id: "vegetable-broth", amount: "3", unit: "cups" },
      { id: "olive-oil", amount: "3", unit: "tbsp" },
      { id: "coconut-milk", amount: "0.5", unit: "cup" },
      { id: "salt", amount: "1", unit: "tsp" },
      { id: "pepper", amount: "0.5", unit: "tsp" },
    ...
    instructions: [
      ...
      "Toss cauliflower with 2 tbsp olive oil, turmeric, salt, and pepper. Spread on a baking sheet.",
      "Roast 25 minutes until golden and caramelized at the edges.",
      "Sauté onion and garlic in remaining olive oil in a pot for 3 minutes.",
      "Add roasted cauliflower and vegetable broth. Simmer 10 minutes.",
      "Blend until silky smooth. Stir in coconut milk for creaminess.",
      "Roasting the cauliflower develops deep flavor while turmeric's curcumin fights inflammation."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 190, protein: 6, carbs: 18, fat: 12, fiber: 5, sodium: 350, cholesterol: 0 },
    cuisine: "healthy",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-beet-salad",
    title: "Roasted Beet & Walnut Salad",
    mealType: "sides",
    description: "Vibrant roasted beets with walnuts, goat cheese, and balsamic — rich in anti-inflammatory betalains",
    cookTime: "45 min",
    servings: 4,
    ingredients: ["beets", "walnuts", "goat-cheese", "arugula", "olive-oil", "balsamic-vinegar", "honey", "salt", "pepper"],
    ingredientAmounts: [
      { id: "beets", amount: "4", unit: "medium" },
      { id: "walnuts", amount: "0.5", unit: "cup" },
      { id: "goat-cheese", amount: "4", unit: "oz crumbled" },
      { id: "arugula", amount: "4", unit: "cups" },
      { id: "olive-oil", amount: "3", unit: "tbsp" },
      { id: "balsamic-vinegar", amount: "2", unit: "tbsp" },
      { id: "honey", amount: "1", unit: "tsp" },
      { id: "salt", amount: "0.5", unit: "tsp" },
      { id: "pepper", amount: "0.25", unit: "tsp" },
    ],
    instructions: [
      "Preheat oven to 400°F. Wrap whole beets in foil and roast 40 minutes until fork-tender.",
      "While beets roast, toast walnuts in a dry skillet over medium heat 3-4 minutes.",
      "Whisk olive oil, balsamic vinegar, honey, salt, and pepper for the dressing.",
      "Let beets cool slightly, then peel and cut into wedges.",
      "Arrange arugula on a platter. Top with beet wedges, crumbled goat cheese, and toasted walnuts.",
      "Drizzle with balsamic dressing. Beets contain betalains, powerful anti-inflammatory pigments."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 260, protein: 8, carbs: 20, fat: 18, fiber: 4, sodium: 280, cholesterol: 10 },
    cuisine: "mediterranean",
    antiInflammatory: true,
  },
  {
    id: "anti-inflam-miso-ginger-stir-fry",
    title: "Miso Ginger Vegetable Stir-Fry",
    mealType: "dinner",
    description: "Quick stir-fry with broccoli, bell peppers, and edamame in an anti-inflammatory miso-ginger sauce",
    cookTime: "15 min",
    servings: 2,
    ingredients: ["broccoli", "bell-pepper", "edamame", "ginger-fresh", "garlic", "miso-paste", "sesame-oil", "soy-sauce", "rice-vinegar", "rice-white"],
    ingredientAmounts: [
      { id: "broccoli", amount: "2", unit: "cups florets" },
      { id: "bell-pepper", amount: "1", unit: "large sliced" },
      { id: "edamame", amount: "1", unit: "cup shelled" },
      { id: "ginger-fresh", amount: "1", unit: "tbsp grated" },
      { id: "garlic", amount: "2", unit: "cloves" },
      { id: "miso-paste", amount: "2", unit: "tbsp" },
      { id: "sesame-oil", amount: "2", unit: "tbsp" },
      { id: "soy-sauce", amount: "1", unit: "tbsp" },
      { id: "rice-vinegar", amount: "1", unit: "tbsp" },
      { id: "rice-white", amount: "2", unit: "cups cooked" },
    ...
    instructions: [
      "Whisk miso paste with soy sauce, rice vinegar, and 2 tbsp water. Set aside.",
      "Heat sesame oil in a wok or large skillet over high heat.",
      "Add broccoli and bell pepper. Stir-fry 3-4 minutes until crisp-tender.",
      "Add edamame, garlic, and ginger. Cook 1 minute.",
      "Pour in miso-ginger sauce. Toss everything to coat evenly.",
      "Serve over steamed rice. Miso is a fermented food that supports gut health, while ginger is a potent anti-inflammatory."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "high-protein"],
    difficulty: "easy",
    nutrition: { calories: 340, protein: 18, carbs: 42, fat: 12, fiber: 6, sodium: 480, cholesterol: 0 },
    cuisine: "asian",
    antiInflammatory: true,
  },
  ...
  // ============ SAUCES & CONDIMENTS ============
  {
    id: "creamy-chipotle-yogurt-sauce",
    title: "Creamy Chipotle Yogurt Sauce",
    mealType: "sides",
    ...
    instructions: [
      ...
      "Mix in 1-2 tsp chipotle powder or adobo sauce (start with less, taste, and adjust for heat).",
      "Squeeze in fresh lime juice (about 1/2 a lime).",
      "Add a pinch of garlic powder and salt.",
      "Drizzle in a little olive oil and stir until smooth and creamy.",
      "Taste and adjust heat, salt, and lime to your preference. Refrigerate until ready to serve.",
      "Great on tacos, burrito bowls, grilled chicken, roasted sweet potatoes, or as a dipping sauce."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free", "low-carb", "high-protein"],
    difficulty: "easy",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Add 1/4 cup plain Greek yogurt, juice of 1 lime, 1 minced garlic clove, and olive oil.",
      "Mash with a fork for a chunky texture, or blend until silky smooth.",
      "Season with salt to taste. If too thick, add a splash of water and stir until you reach desired consistency.",
      "Serve immediately or refrigerate with plastic wrap pressed directly onto the surface to prevent browning.",
      "Perfect drizzled on tacos, grain bowls, grilled fish, roasted vegetables, or as a dip with tortilla chips."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free", "low-carb", "high-protein"],
    difficulty: "easy",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Add 1 minced garlic clove, a drizzle of olive oil, salt, and a pinch of ground cumin.",
      "The mixture will thicken at first — gradually add 2-3 tbsp cold water, whisking until smooth and pourable.",
      "Taste and adjust lemon, salt, and garlic to your preference.",
      "Drizzle over falafel, roasted cauliflower, grain bowls, or use as a salad dressing."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free", "dairy-free"],
    difficulty: "easy",
  ...
  },
  {
    ...
    title: "Cilantro Lime Yogurt Sauce",
    mealType: "sides",
    ...
    instructions: [
      ...
      "Squeeze in juice of 1 lime and add garlic powder, olive oil, and a pinch of salt.",
      "Stir well until evenly combined. For a smoother sauce, blend in a food processor.",
      "Taste and adjust lime and salt. Refrigerate for 15 minutes to let flavors meld.",
      "Drizzle over tacos, burrito bowls, grilled chicken, or roasted sweet potatoes."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free", "low-carb", "high-protein"],
    difficulty: "easy",
  ...
  },
  {
    ...
    ingredientAmounts: [
      ...
      { id: "garlic", amount: "2", unit: "cloves minced" },
      { id: "dill", amount: "1", unit: "tbsp fresh chopped" },
      { id: "lemon", amount: "1", unit: "tbsp juice" },
      { id: "olive-oil", amount: "1", unit: "tbsp" },
      { id: "salt", amount: "1/4", unit: "tsp" },
    ],
    instructions: [
      ...
      "Combine 1 cup Greek yogurt with the squeezed cucumber in a bowl.",
      "Add 2 minced garlic cloves, 1 tbsp chopped fresh dill, lemon juice, and olive oil.",
      "Season with salt and stir well. Taste and adjust garlic and lemon.",
      "Refrigerate for at least 30 minutes before serving — flavors improve as it chills.",
      "Serve with gyros, grilled lamb, chicken, pita bread, or as a dip for veggies."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free", "low-carb", "high-protein"],
    difficulty: "easy",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Add a squeeze of lime juice, garlic powder, and sesame oil. Stir until smooth.",
      "Taste and adjust: more honey for sweetness, more sriracha for heat.",
      "Use as a glaze (brush on chicken or salmon in the last 5 minutes of cooking), a dipping sauce, or toss with roasted cauliflower.",
  ...
  },
  {
    ...
    title: "Garlic Herb Yogurt Sauce",
    mealType: "sides",
    ...
    ingredientAmounts: [
      { id: "yogurt-greek-plain", amount: "1/2", unit: "cup" },
      { id: "garlic", amount: "1", unit: "clove minced" },
      { id: "dill", amount: "1", unit: "tbsp chopped" },
      { id: "parsley", amount: "1", unit: "tbsp chopped" },
      { id: "lemon", amount: "1", unit: "tsp juice" },
      { id: "olive-oil", amount: "1", unit: "tsp" },
      { id: "salt", amount: "1", unit: "pinch" },
    ...
    instructions: [
      ...
      "Add 1 tbsp each of chopped fresh dill and parsley.",
      "Stir in lemon juice, olive oil, salt, and pepper.",
      "Mix until smooth. Let sit in the fridge for 15 minutes for best flavor.",
      "Serve with grilled chicken, roasted vegetables, grain bowls, or spread on flatbreads and wraps."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free", "low-carb", "high-protein"],
    difficulty: "easy",
  ...
  // ============ ROPE BEEF SAUSAGE EGG ROLLS ============
  {
    id: "rope-beef-sausage-egg-rolls",
    title: "Rope Beef Sausage Egg Rolls",
    mealType: "dinner",
    ...
    instructions: [
      ...
      "Heat a large skillet over medium heat. Add the chopped sausage and sauté for 5-7 minutes until browned and cooked through, breaking it apart as it cooks.",
      "Add the diced onion and minced garlic to the skillet. Cook for 2-3 minutes until softened and fragrant.",
      "Pour in 1 cup BBQ sauce and stir to coat. Add 1/2 tsp black pepper. Mix well and remove from heat.",
      "Let the sausage mixture cool completely, about 15-20 minutes. This prevents the wrappers from getting soggy.",
      "Lay out an egg roll wrapper with one corner facing you (diamond shape). Place a small handful of coleslaw mix in the center, then add 2-3 tablespoons of the sausage filling on top.",
      "Fold the bottom corner up over the filling. Fold in the left and right sides tightly. Roll upward toward the top corner. Dip your finger in water and moisten the top edge to seal tightly.",
      "Repeat with remaining wrappers and filling. Place assembled egg rolls on a parchment-lined baking sheet.",
      "Refrigerate the assembled egg rolls for 1-2 hours to chill. This helps them hold their shape and fry crispier.",
    ...
    suggestedSides: [
      ...
      { name: "Classic Coleslaw", description: "Cool, creamy slaw to balance the smoky richness" },
      { name: "Fried Rice", description: "Turn it into a full spread with veggie or egg fried rice" },
    ],
  },
  // ============ SWEET CHILI DIPPING SAUCE ============
  {
    id: "sweet-chili-dipping-sauce",
    title: "Sweet Chili Dipping Sauce",
    mealType: "sides",
    description: "Sticky, sweet, and spicy Thai-style chili sauce perfect for egg rolls, spring rolls, and chicken",
    cookTime: "15 min",
    servings: 8,
    ingredients: ["sugar-white", "rice-vinegar", "garlic", "red-pepper-flakes", "cornstarch", "salt"],
    ingredientAmounts: [
      { id: "sugar-white", amount: "0.5", unit: "cup" },
      { id: "rice-vinegar", amount: "0.5", unit: "cup" },
      { id: "garlic", amount: "3", unit: "cloves, minced" },
      { id: "red-pepper-flakes", amount: "1", unit: "tsp" },
      { id: "cornstarch", amount: "1", unit: "tbsp" },
      { id: "salt", amount: "0.25", unit: "tsp" },
    ],
    instructions: [
      "In a small saucepan, combine 1/2 cup sugar, 1/2 cup rice vinegar, 3 minced garlic cloves, 1 tsp red pepper flakes, and 1/4 tsp salt.",
      "Bring to a boil over medium-high heat, stirring until sugar dissolves completely.",
      "Reduce heat and simmer for 5 minutes to let the garlic and pepper flakes infuse.",
      "In a small bowl, whisk 1 tbsp cornstarch with 2 tbsp cold water until smooth to make a slurry.",
      "Pour the cornstarch slurry into the simmering sauce while stirring constantly. Cook for 1-2 minutes until the sauce thickens and becomes glossy.",
      "Remove from heat and let cool. The sauce will thicken more as it cools.",
      "Transfer to a jar or dipping bowl. Store in the fridge for up to 2 weeks. Serve with egg rolls, spring rolls, chicken tenders, or shrimp.",
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "dairy-free", "nut-free"],
    difficulty: "easy",
    nutrition: { calories: 55, protein: 0, carbs: 14, fat: 0, fiber: 0, sodium: 80, cholesterol: 0 },
    cuisine: "asian",
    suggestedSides: [
      { name: "Rope Beef Sausage Egg Rolls", description: "These crispy BBQ sausage rolls were made for this sauce" },
      { name: "Chicken Tenders", description: "A sweet-spicy upgrade from basic ketchup" },
      { name: "Spring Rolls", description: "Classic pairing with fresh or fried spring rolls" },
    ],
  },
  // ============ HOT MUSTARD DIPPING SAUCE ============
  {
    id: "hot-mustard-dipping-sauce",
    ...
    instructions: [
      ...
      "Add 3 tablespoons of cold water and stir until a smooth paste forms. The mixture will be thick.",
      "Add 1 tablespoon rice vinegar and 1/4 tsp salt. Stir until smooth and combined.",
      "Let the mustard sit for 10 minutes before serving — this allows the heat to develop fully. The longer it sits, the milder it becomes, so serve quickly for maximum kick.",
      "For a slightly sweeter version, stir in 1/2 tsp honey or a pinch of sugar.",
      "Serve alongside egg rolls, dumplings, pretzels, or use as a spread on sandwiches. Store covered in the fridge for up to 1 week.",
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "dairy-free", "gluten-free", "nut-free", "low-carb"],
    difficulty: "easy",
    nutrition: { calories: 15, protein: 1, carbs: 1, fat: 1, fiber: 0, sodium: 100, cholesterol: 0 },
    cuisine: "asian",
    suggestedSides: [
      { name: "Rope Beef Sausage Egg Rolls", description: "A bold, sharp dip for smoky BBQ egg rolls" },
      { name: "Pork Dumplings", description: "Classic Chinese takeout pairing" },
      { name: "Soft Pretzels", description: "Hot mustard takes pretzels to the next level" },
    ],
  },
  // ============ ESSENTIAL SIDES & PAIRINGS ============
  {
    ...
    title: "French Fries",
    mealType: "sides",
    description: "Crispy golden fries with a fluffy interior — the classic side dish",
    cookTime: "30 min",
    servings: 4,
    ingredients: ["potato", "oil", "salt"],
    instructions: [
      "Cut potatoes into 1/4-inch strips and soak in cold water for 30 minutes.",
      "Drain and pat completely dry with paper towels.",
      "Heat oil to 325°F. Fry strips 5-6 minutes until soft but not browned. Remove and drain.",
      "Increase oil to 375°F. Fry again 2-3 minutes until golden and crispy.",
      "Season immediately with salt. Serve hot."
    ],
    matchedIngredients: [],
    difficulty: "easy",
    nutrition: { calories: 312, protein: 4, carbs: 41, fat: 15, fiber: 3, sodium: 210 },
  },
  {
    id: "sweet-potato-fries",
    title: "Sweet Potato Fries",
    mealType: "sides",
    description: "Crispy baked sweet potato fries with a hint of sweetness",
    cookTime: "35 min",
    servings: 4,
    ingredients: ["sweet-potato", "oil", "salt", "paprika"],
    instructions: [
      "Preheat oven to 425°F. Cut sweet potatoes into 1/4-inch strips.",
      "Toss with oil, salt, and paprika. Spread in a single layer on a lined baking sheet.",
      "Bake 15 minutes, flip, and bake another 10-15 minutes until crispy.",
      "Serve immediately for best crunch."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 180, protein: 2, carbs: 28, fat: 7, fiber: 4, sodium: 190 },
  },
  {
    id: "steamed-rice",
    title: "Steamed Rice",
    ...
    instructions: [
      "Rinse 2 cups rice under cold water until water runs clear.",
      "Combine rice with 2.5 cups water and a pinch of salt in a pot.",
      "Bring to a boil, then reduce to lowest heat. Cover and cook 18 minutes.",
      "Remove from heat and let steam, covered, for 5 minutes. Fluff with a fork."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 205, protein: 4, carbs: 45, fat: 0, fiber: 1, sodium: 5 },
  },
  {
    id: "mexican-rice",
    title: "Mexican Rice",
    ...
    instructions: [
      ...
      "Add 1 can diced tomatoes, 2 cups chicken broth, cumin, salt.",
      "Bring to a boil, cover, reduce heat. Simmer 18-20 minutes.",
      "Fluff with fork and let rest 5 minutes before serving."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 220, protein: 5, carbs: 42, fat: 4, fiber: 2, sodium: 380 },
    cuisine: "mexican",
  },
  {
    id: "crispy-egg-rolls",
    ...
    instructions: [
      ...
      "Place 2-3 tablespoons filling on each egg roll wrapper. Fold and roll tightly, sealing edges with water.",
      "Heat oil to 350°F. Fry egg rolls 3-4 minutes per side until golden brown.",
      "Drain on paper towels. Serve with sweet chili sauce or soy dipping sauce."
    ],
    matchedIngredients: [],
    difficulty: "medium",
    nutrition: { calories: 180, protein: 8, carbs: 18, fat: 9, fiber: 1, sodium: 320 },
    cuisine: "asian",
  },
  {
    id: "homemade-tortilla-chips",
    title: "Homemade Tortilla Chips",
    mealType: "sides",
    description: "Crunchy baked or fried tortilla chips from scratch",
    cookTime: "15 min",
    servings: 6,
    ingredients: ["tortilla-flour", "oil", "salt"],
    instructions: [
      "Cut tortillas into 6 wedges each.",
      "For baking: brush with oil, spread on sheet pan, bake at 375°F for 10-12 minutes.",
      "For frying: heat oil to 350°F, fry wedges 2-3 minutes until golden.",
      "Season immediately with salt. Serve with salsa or guacamole."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan"],
    difficulty: "easy",
    nutrition: { calories: 140, protein: 2, carbs: 19, fat: 6, fiber: 1, sodium: 180 },
    cuisine: "mexican",
  },
  {
    id: "roasted-vegetables",
    ...
    instructions: [
      ...
      "Spread in a single layer on a lined baking sheet — don't overcrowd.",
      "Roast 25-30 minutes, tossing halfway, until edges are caramelized."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 95, protein: 3, carbs: 12, fat: 5, fiber: 4, sodium: 150 },
  },
  {
    id: "roasted-potatoes",
    title: "Roasted Potatoes",
    mealType: "sides",
    description: "Crispy-on-the-outside, fluffy-on-the-inside roasted potatoes",
    cookTime: "45 min",
    servings: 4,
    ingredients: ["potato", "olive-oil", "garlic", "rosemary", "salt", "pepper"],
    instructions: [
      "Preheat oven to 425°F. Cut potatoes into 1-inch chunks.",
      "Toss with olive oil, minced garlic, rosemary, salt, and pepper.",
      "Spread in single layer on baking sheet. Roast 20 minutes.",
      "Flip potatoes and roast another 15-20 minutes until golden and crispy."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 180, protein: 3, carbs: 30, fat: 6, fiber: 3, sodium: 200 },
  },
  {
    id: "classic-coleslaw",
    title: "Classic Coleslaw",
    mealType: "sides",
    description: "Creamy, crunchy coleslaw with a tangy dressing",
    cookTime: "15 min",
    servings: 6,
    ingredients: ["cabbage", "carrot", "mayonnaise", "apple-cider-vinegar", "sugar", "salt"],
    instructions: [
      "Shred cabbage and grate carrots into a large bowl.",
      "Whisk together mayonnaise, apple cider vinegar, sugar, and salt.",
    ...
    dietaryTags: ["gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 120, protein: 1, carbs: 8, fat: 10, fiber: 2, sodium: 180 },
  },
  {
    ...
    instructions: [
      ...
      "Bake at 425°F for 20 minutes. Flip and bake another 20-25 minutes until very crispy.",
      "Toss with your favorite sauce — buffalo, BBQ, honey garlic, or plain with ranch."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "high-protein", "low-carb"],
    difficulty: "easy",
    nutrition: { calories: 280, protein: 24, carbs: 2, fat: 20, fiber: 0, sodium: 450 },
    cuisine: "american",
  },
  {
    id: "corn-on-the-cob",
    ...
    mealType: "sides",
    description: "Sweet, juicy corn on the cob with butter",
    cookTime: "15 min",
    servings: 4,
    ingredients: ["corn-on-cob", "butter", "salt"],
    instructions: [
      "Bring a large pot of water to a boil.",
      "Add shucked corn and cook 5-7 minutes until tender.",
      "Remove and serve with butter and salt."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 155, protein: 4, carbs: 25, fat: 6, fiber: 3, sodium: 120 },
  },
  {
    id: "homemade-cream-cheese-spread",
    title: "Homemade Cream Cheese Spread",
    mealType: "sides",
    description: "Whipped cream cheese with herbs and seasonings for bagels",
    cookTime: "5 min",
    servings: 8,
    ingredients: ["cream-cheese", "chives", "garlic", "salt", "pepper"],
    instructions: [
      "Let cream cheese come to room temperature.",
      "Beat cream cheese until smooth and fluffy.",
      "Mix in minced chives, a touch of garlic, salt, and pepper.",
      "Serve on bagels, toast, or crackers. Keeps refrigerated up to 1 week."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 90, protein: 2, carbs: 1, fat: 9, fiber: 0, sodium: 95 },
  },
  {
    id: "refried-beans",
    title: "Refried Beans",
    mealType: "sides",
    description: "Creamy, flavorful refried pinto beans from scratch",
    cookTime: "25 min",
    servings: 6,
    ingredients: ["beans-pinto", "onion", "garlic", "cumin", "oil", "salt"],
    instructions: [
      "Sauté diced onion and garlic in oil until softened.",
      "Add drained pinto beans (2 cans) and cumin. Cook 5 minutes.",
      "Mash beans to desired consistency — chunky or smooth.",
      "Season with salt. Add water or broth if too thick."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 160, protein: 9, carbs: 26, fat: 3, fiber: 7, sodium: 380 },
    cuisine: "mexican",
  },
  {
    id: "warm-pita-bread",
    ...
    mealType: "sides",
    description: "Soft, pillowy homemade pita bread that puffs up perfectly",
    cookTime: "30 min",
    servings: 8,
    ingredients: ["flour", "yeast-active", "sugar", "salt", "olive-oil"],
    instructions: [
      "Mix flour, yeast, sugar, salt. Add warm water and olive oil. Knead 8 minutes.",
      "Let dough rise 1 hour until doubled.",
      "Divide into 8 balls. Roll each into a 6-inch circle.",
      "Cook on a very hot skillet or cast iron 1-2 minutes per side until puffed.",
      "Wrap in a towel to keep warm and soft."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan"],
    difficulty: "medium",
    nutrition: { calories: 170, protein: 5, carbs: 32, fat: 2, fiber: 1, sodium: 290 },
    cuisine: "middle-eastern",
  },
  {
    id: "roasted-broccoli",
    ...
    mealType: "sides",
    description: "Crispy, caramelized roasted broccoli with garlic and lemon",
    cookTime: "25 min",
    servings: 4,
    ingredients: ["broccoli", "olive-oil", "garlic", "lemon", "salt", "pepper"],
    instructions: [
      "Preheat oven to 425°F. Cut broccoli into florets.",
      "Toss with olive oil, sliced garlic, salt, and pepper.",
      "Spread in a single layer on a baking sheet.",
      "Roast 20-25 minutes until edges are charred. Squeeze lemon juice over top."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 75, protein: 4, carbs: 8, fat: 4, fiber: 3, sodium: 160 },
  },
  {
    id: "soft-pretzels",
    title: "Soft Pretzels",
    ...
    instructions: [
      ...
      "Shape into pretzels. Boil each in water with baking soda for 30 seconds.",
      "Place on lined baking sheet. Brush with egg wash and sprinkle coarse salt.",
      "Bake at 425°F for 12-14 minutes until deep golden brown."
    ],
    matchedIngredients: [],
    difficulty: "medium",
    nutrition: { calories: 280, protein: 7, carbs: 52, fat: 5, fiber: 2, sodium: 680 },
  },
  {
    id: "churros",
    title: "Churros",
    mealType: "dessert",
    description: "Crispy fried churros coated in cinnamon sugar",
    cookTime: "30 min",
    servings: 12,
    ingredients: ["flour", "butter", "sugar", "salt", "eggs", "cinnamon", "oil"],
    instructions: [
      "Bring water, butter, sugar, and salt to a boil. Remove from heat and stir in flour until a ball forms.",
      "Let cool slightly, then beat in eggs one at a time until smooth.",
      "Transfer dough to a piping bag with a star tip.",
      "Pipe 4-inch strips into 375°F oil. Fry 2-3 minutes until golden.",
      "Roll immediately in cinnamon sugar. Serve with chocolate dipping sauce."
    ],
    matchedIngredients: [],
    difficulty: "medium",
    nutrition: { calories: 150, protein: 2, carbs: 18, fat: 8, fiber: 0, sodium: 90 },
  },
  {
    id: "chow-mein",
    title: "Chow Mein",
    ...
    instructions: [
      ...
      "Add noodles and soy sauce. Toss everything together over high heat 2-3 minutes.",
      "Serve hot, garnished with green onions."
    ],
    matchedIngredients: [],
    difficulty: "easy",
    nutrition: { calories: 260, protein: 8, carbs: 38, fat: 9, fiber: 3, sodium: 520 },
    cuisine: "asian",
  },
  {
    ...
    mealType: "sides",
    description: "Creamy Louisiana-style red beans served over fluffy rice",
    cookTime: "45 min",
    servings: 6,
    ingredients: ["beans-kidney", "rice", "onion", "celery", "garlic", "cajun-seasoning", "chicken-broth"],
    instructions: [
      "Sauté diced onion, celery, and garlic until softened.",
      "Add drained kidney beans, chicken broth, and Cajun seasoning.",
      "Simmer 30 minutes, mashing some beans to thicken.",
      "Cook rice separately. Serve beans ladled over hot rice."
    ],
    matchedIngredients: [],
    difficulty: "easy",
    nutrition: { calories: 280, protein: 12, carbs: 50, fat: 3, fiber: 8, sodium: 480 },
    cuisine: "american",
  },
  {
    id: "elote-mexican-street-corn",
    ...
    dietaryTags: ["vegetarian", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 200, protein: 5, carbs: 22, fat: 12, fiber: 3, sodium: 280 },
    cuisine: "mexican",
  },
  {
    ...
    mealType: "sides",
    description: "Tender-crisp roasted asparagus with olive oil and lemon",
    cookTime: "15 min",
    servings: 4,
    ingredients: ["asparagus", "olive-oil", "garlic", "lemon", "salt", "pepper"],
    instructions: [
      "Preheat oven to 425°F. Trim woody ends from asparagus.",
      "Toss with olive oil, garlic, salt, and pepper on a baking sheet.",
      "Roast 10-12 minutes until tender-crisp with charred tips.",
      "Finish with a squeeze of lemon juice."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegan", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 60, protein: 3, carbs: 5, fat: 4, fiber: 2, sodium: 150 },
  },
  {
    id: "rice-pilaf",
    title: "Rice Pilaf",
    ...
    instructions: [
      ...
      "Pour in chicken broth, bring to a boil. Cover and simmer 18 minutes.",
      "Let rest 5 minutes, then fluff with a fork."
    ],
    matchedIngredients: [],
    difficulty: "easy",
    nutrition: { calories: 220, protein: 5, carbs: 40, fat: 5, fiber: 1, sodium: 340 },
  },
  {
    id: "creamy-polenta",
    ...
    instructions: [
      ...
      "Reduce heat to low. Stir frequently for 25-30 minutes until thick and creamy.",
      "Stir in butter and grated parmesan. Season with salt and pepper."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "gluten-free"],
    difficulty: "easy",
    nutrition: { calories: 200, protein: 6, carbs: 28, fat: 8, fiber: 2, sodium: 250 },
    cuisine: "italian",
  },
  {
    id: "spring-rolls",
    ...
    cookTime: "25 min",
    servings: 8,
    ingredients: ["rice-paper", "shrimp", "lettuce", "carrot", "cucumber", "mint", "rice-noodles"],
    instructions: [
      "Cook rice noodles and shrimp. Let cool completely.",
      "Dip a rice paper wrapper in warm water for 10 seconds until pliable.",
      "Layer lettuce, noodles, vegetables, herbs, and shrimp in the center.",
      "Fold bottom up, fold sides in, and roll tightly.",
      "Serve with peanut sauce or sweet chili dipping sauce."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "dairy-free"],
    difficulty: "easy",
    nutrition: { calories: 90, protein: 6, carbs: 14, fat: 1, fiber: 1, sodium: 180 },
    cuisine: "asian",
  },
  {
    ...
    mealType: "sides",
    description: "Simple buttered egg noodles with parsley — the perfect comfort side",
    cookTime: "15 min",
    servings: 4,
    ingredients: ["egg-noodles", "butter", "parsley", "salt", "pepper"],
    instructions: [
      "Cook egg noodles in salted boiling water according to package directions.",
      "Drain and return to pot. Add butter and toss until melted and coated.",
      "Season with salt and pepper. Garnish with fresh chopped parsley."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "easy",
    nutrition: { calories: 250, protein: 7, carbs: 38, fat: 8, fiber: 2, sodium: 200 },
    cuisine: "comfort",
  },
  // ============ SPRING / EASTER / MOTHER'S DAY ============
  {
    id: "spring-quiche-lorraine",
    title: "Classic Quiche Lorraine",
    mealType: "breakfast",
    description: "Buttery, flaky crust filled with creamy eggs, bacon, and Gruyère cheese",
    cookTime: "1 hour",
    servings: 8,
    ingredients: ["eggs", "cream", "bacon", "gruyere", "pie-crust", "onion", "salt", "pepper", "nutmeg"],
    ingredientAmounts: [
      { id: "eggs", amount: "6", unit: "large" },
      { id: "cream", amount: "1.5", unit: "cups" },
      { id: "bacon", amount: "8", unit: "strips" },
      { id: "gruyere", amount: "1.5", unit: "cups shredded" },
      { id: "pie-crust", amount: "1", unit: "9-inch" },
      { id: "onion", amount: "1", unit: "medium, diced" },
    ],
    instructions: [
      "Preheat oven to 375°F. Par-bake pie crust for 10 minutes with pie weights.",
      "Cook bacon until crispy, crumble. Sauté onion in bacon fat until translucent.",
      "Whisk eggs, cream, salt, pepper, and nutmeg until smooth.",
      "Layer bacon, onion, and Gruyère in par-baked crust.",
      "Pour egg mixture over filling. Bake 35-40 minutes until set and golden.",
      "Let cool 10 minutes before slicing."
    ],
    matchedIngredients: [],
    dietaryTags: ["high-protein"],
    difficulty: "medium",
    nutrition: { calories: 380, protein: 18, carbs: 16, fat: 28, fiber: 1, sodium: 520 },
    cuisine: "french",
    season: "spring",
    suggestedSides: [
      { name: "Mixed Berry Salad", description: "Fresh berries with mint and honey complement the rich quiche" },
      { name: "Lavender Lemonade", description: "Floral lemonade pairs beautifully at brunch" },
    ],
  },
  {
    id: "spring-vegetable-quiche",
    title: "Spring Vegetable Quiche",
    mealType: "breakfast",
    description: "Light egg quiche loaded with asparagus, peas, and fresh herbs",
    cookTime: "55 min",
    servings: 8,
    ingredients: ["eggs", "cream", "asparagus", "peas", "goat-cheese", "pie-crust", "chives", "dill", "salt", "pepper"],
    ingredientAmounts: [
      { id: "eggs", amount: "5", unit: "large" },
      { id: "cream", amount: "1", unit: "cup" },
      { id: "asparagus", amount: "1", unit: "bunch, trimmed" },
      { id: "peas", amount: "1", unit: "cup" },
      { id: "goat-cheese", amount: "4", unit: "oz" },
      { id: "pie-crust", amount: "1", unit: "9-inch" },
    ],
    instructions: [
      "Preheat oven to 375°F. Par-bake pie crust for 10 minutes.",
      "Blanch asparagus and peas for 2 minutes, then ice bath. Cut asparagus into 1-inch pieces.",
      "Whisk eggs, cream, salt, pepper, chopped chives, and dill.",
      "Arrange vegetables in crust, crumble goat cheese over top.",
      "Pour egg mixture over. Bake 35-40 minutes until golden and set.",
      "Cool 10 minutes before slicing. Garnish with fresh herbs."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "medium",
    nutrition: { calories: 290, protein: 14, carbs: 18, fat: 18, fiber: 3, sodium: 380 },
    cuisine: "french",
    season: "spring",
    suggestedSides: [
      { name: "Mixed Green Salad", description: "Light greens with lemon vinaigrette" },
      { name: "Virgin Mimosa", description: "Sparkling OJ for a festive brunch" },
    ],
  },
  {
    id: "hot-cross-buns",
    ...
    instructions: [
      ...
      "Mix flour, remaining sugar, cinnamon, nutmeg, and salt. Add yeast mixture, melted butter, and eggs. Knead 8 minutes until smooth.",
      "Fold in raisins and orange zest. Rise covered for 1 hour until doubled.",
      "Divide into 12 balls, place on lined baking sheet. Rise 30 minutes.",
      "Mix 1/3 cup flour with water to make paste for crosses. Pipe crosses on each bun.",
      "Bake at 375°F for 18-20 minutes until golden.",
      "Brush warm buns with honey glaze (2 tbsp honey + 1 tbsp warm water)."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "medium",
    nutrition: { calories: 220, protein: 6, carbs: 38, fat: 6, fiber: 2, sodium: 180 },
    cuisine: "comfort",
    season: "spring",
    suggestedSides: [
      { name: "Classic Café Latte", description: "Warm latte alongside spiced buns" },
      { name: "London Fog", description: "Earl Grey latte complements the warm spices" },
    ],
  },
  {
    id: "honey-glazed-easter-ham",
    title: "Honey Mustard Glazed Easter Ham",
    mealType: "dinner",
    description: "Juicy spiral ham with a sweet honey-Dijon glaze, studded with cloves",
    cookTime: "3 hours",
    servings: 16,
    ingredients: ["ham", "honey", "dijon-mustard", "brown-sugar", "cloves", "apple-cider-vinegar", "butter"],
    ingredientAmounts: [
      { id: "ham", amount: "10", unit: "lb spiral" },
      { id: "honey", amount: "1", unit: "cup" },
      { id: "dijon-mustard", amount: "1/3", unit: "cup" },
      { id: "brown-sugar", amount: "1/2", unit: "cup" },
      { id: "butter", amount: "4", unit: "tbsp" },
    ],
    instructions: [
      "Preheat oven to 325°F. Place ham cut-side down in roasting pan, cover with foil.",
      "Bake 12-15 minutes per pound until internal temp reaches 130°F.",
      "Make glaze: simmer honey, mustard, brown sugar, vinegar, and butter until thickened.",
      "During last 30 minutes, remove foil. Brush ham generously with glaze every 10 minutes.",
      "Stud top with whole cloves for presentation.",
      "Let rest 15 minutes before carving. Serve with extra glaze."
    ],
    matchedIngredients: [],
    dietaryTags: ["high-protein", "gluten-free"],
    difficulty: "medium",
    nutrition: { calories: 320, protein: 28, carbs: 18, fat: 16, fiber: 0, sodium: 1200 },
    cuisine: "american",
    season: "spring",
    suggestedSides: [
      { name: "Honey Glazed Carrots", description: "Sweet carrots echo the ham's honey glaze" },
      { name: "Classic Deviled Eggs", description: "The essential Easter appetizer" },
      { name: "Soft Butter Dinner Rolls", description: "Warm rolls to soak up the glaze" },
    ],
  },
  {
    id: "spring-lamb-rack",
    ...
    mealType: "dinner",
    description: "Elegant rack of lamb with a fragrant herb and breadcrumb crust",
    cookTime: "45 min",
    servings: 4,
    ingredients: ["lamb-rack", "dijon-mustard", "breadcrumbs", "garlic", "rosemary", "thyme", "parsley", "olive-oil", "salt", "pepper"],
    ingredientAmounts: [
      { id: "lamb-rack", amount: "2", unit: "racks (8 ribs each)" },
      { id: "dijon-mustard", amount: "3", unit: "tbsp" },
      { id: "breadcrumbs", amount: "1", unit: "cup" },
      { id: "garlic", amount: "4", unit: "cloves minced" },
      { id: "rosemary", amount: "2", unit: "tbsp chopped" },
    ],
    instructions: [
      "Preheat oven to 425°F. Season lamb with salt and pepper.",
      "Sear in hot skillet with olive oil, 2 minutes per side.",
      "Mix breadcrumbs, herbs, garlic, and olive oil.",
      "Brush seared lamb with Dijon mustard, press herb crust on top.",
      "Roast 20-25 minutes for medium-rare (130°F internal).",
      "Rest 10 minutes before cutting into individual chops."
    ],
    matchedIngredients: [],
    dietaryTags: ["high-protein"],
    difficulty: "hard",
    nutrition: { calories: 450, protein: 35, carbs: 12, fat: 28, fiber: 1, sodium: 380 },
    cuisine: "french",
    season: "spring",
    suggestedSides: [
      { name: "Roasted Asparagus", description: "Classic spring pairing with lamb" },
      { name: "Mint Chutney", description: "Traditional lamb accompaniment" },
    ],
  },
  {
    id: "strawberry-shortcake-spring",
    title: "Classic Strawberry Shortcake",
    mealType: "dessert",
    ...
    instructions: [
      ...
      "Mix flour, 1/4 cup sugar, baking powder, and salt. Cut in cold butter until crumbly.",
      "Stir in 3/4 cup cream and egg. Pat dough 1 inch thick, cut into rounds.",
      "Brush tops with cream, sprinkle sugar. Bake 12-15 minutes until golden.",
      "Whip remaining cream with 2 tbsp sugar and vanilla until stiff peaks.",
      "Split biscuits, layer with macerated strawberries and whipped cream."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "easy",
    nutrition: { calories: 340, protein: 5, carbs: 42, fat: 18, fiber: 2, sodium: 220 },
    cuisine: "american",
    season: "spring",
    suggestedSides: [
      { name: "Lavender Lemonade", description: "Floral lemonade with spring berries" },
    ],
  },
  {
    id: "lemon-raspberry-pavlova",
    title: "Lemon Raspberry Pavlova",
    mealType: "dessert",
    description: "Crisp meringue nest with lemon curd and fresh raspberries",
    cookTime: "2 hours",
    servings: 8,
    ingredients: ["egg-whites", "sugar", "cream", "lemon", "raspberries", "cornstarch", "vanilla", "butter"],
    ingredientAmounts: [
      { id: "egg-whites", amount: "6", unit: "large" },
      { id: "sugar", amount: "1.5", unit: "cups" },
      { id: "cream", amount: "1.5", unit: "cups" },
      { id: "lemon", amount: "3", unit: "juiced + zested" },
      { id: "raspberries", amount: "2", unit: "cups" },
    ],
    instructions: [
      "Preheat oven to 250°F. Beat egg whites until stiff, gradually add sugar and cornstarch.",
      "Shape meringue into a nest on parchment-lined sheet. Bake 1.5 hours, cool in oven.",
      "Make lemon curd: whisk lemon juice, zest, sugar, eggs, and butter over double boiler until thick. Chill.",
      "Whip cream with vanilla until stiff peaks.",
      "Top pavlova with whipped cream, lemon curd, and fresh raspberries.",
      "Serve immediately — pavlova is best the day it's assembled."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "vegetarian"],
    difficulty: "hard",
    nutrition: { calories: 310, protein: 5, carbs: 48, fat: 12, fiber: 2, sodium: 60 },
    cuisine: "french",
    season: "spring",
  },
  {
    id: "mothers-day-eggs-florentine",
    title: "Eggs Florentine with Hollandaise",
    mealType: "breakfast",
    ...
    instructions: [
      ...
      "Wilt spinach in a pan with a splash of water, season with salt.",
      "Bring a pot of water to gentle simmer, add vinegar. Poach eggs 3-4 minutes.",
      "Toast English muffins. Layer with spinach, poached egg, and hollandaise.",
      "Garnish with cracked pepper and chives."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian", "high-protein"],
    difficulty: "medium",
    nutrition: { calories: 420, protein: 18, carbs: 22, fat: 30, fiber: 2, sodium: 480 },
    cuisine: "french",
    season: "spring",
  },
  {
    id: "spring-pea-mint-risotto",
    ...
    instructions: [
      ...
      "Add rice, stir to toast 2 minutes. Deglaze with white wine.",
      "Add warm broth one ladle at a time, stirring until absorbed before adding more.",
      "After 15 minutes, stir in peas. Continue adding broth for 5 more minutes.",
      "Remove from heat. Stir in Parmesan, butter, and chopped mint.",
      "Season with salt and pepper. Serve topped with more mint and Parmesan shavings."
    ],
    matchedIngredients: [],
    dietaryTags: ["vegetarian"],
    difficulty: "medium",
    nutrition: { calories: 380, protein: 14, carbs: 52, fat: 12, fiber: 5, sodium: 580 },
    cuisine: "italian",
    season: "spring",
    suggestedSides: [
      { name: "Mixed Green Salad", description: "Light greens to balance the rich risotto" },
    ],
  },
  {
    id: "grilled-lemon-herb-chicken-spring",
    title: "Grilled Lemon Herb Chicken",
    mealType: "dinner",
    description: "Juicy butterflied chicken marinated in lemon, herbs, and garlic — perfect for spring grilling",
    cookTime: "1 hour",
    servings: 6,
    ingredients: ["whole-chicken", "lemon", "garlic", "rosemary", "thyme", "oregano", "olive-oil", "salt", "pepper"],
    ingredientAmounts: [
      { id: "whole-chicken", amount: "1", unit: "4-5 lb butterflied" },
      { id: "lemon", amount: "3", unit: "juiced + zested" },
      { id: "garlic", amount: "6", unit: "cloves minced" },
      { id: "olive-oil", amount: "1/4", unit: "cup" },
    ],
    instructions: [
      "Mix lemon juice, zest, garlic, chopped herbs, and olive oil. Season with salt and pepper.",
      "Marinate butterflied chicken for at least 2 hours (overnight is best).",
      "Preheat grill to medium-high. Place chicken skin-side down.",
      "Grill 20-25 minutes per side until internal temp reaches 165°F.",
      "Rest 10 minutes before carving. Squeeze fresh lemon over top.",
      "Garnish with fresh herbs and serve with grilled lemon halves."
    ],
    matchedIngredients: [],
    dietaryTags: ["high-protein", "gluten-free", "paleo"],
    difficulty: "medium",
    nutrition: { calories: 380, protein: 42, carbs: 4, fat: 22, fiber: 0, sodium: 420 },
    cuisine: "mediterranean",
    season: "spring",
  },
  {
    id: "asparagus-prosciutto-bundles",
    title: "Asparagus & Prosciutto Bundles",
    mealType: "sides",
    description: "Tender asparagus wrapped in crispy prosciutto — an elegant spring appetizer",
    cookTime: "15 min",
    servings: 6,
    ingredients: ["asparagus", "prosciutto", "olive-oil", "parmesan", "lemon", "pepper"],
    ingredientAmounts: [
      { id: "asparagus", amount: "24", unit: "spears" },
      { id: "prosciutto", amount: "12", unit: "slices" },
      { id: "parmesan", amount: "1/4", unit: "cup shaved" },
      { id: "lemon", amount: "1", unit: "juiced" },
    ],
    instructions: [
      "Preheat oven to 400°F. Trim asparagus ends.",
      "Wrap 2 asparagus spears in each prosciutto slice.",
      "Place on baking sheet, drizzle with olive oil.",
      "Roast 10-12 minutes until prosciutto is crispy.",
      "Finish with lemon juice, shaved Parmesan, and cracked pepper."
    ],
    matchedIngredients: [],
    dietaryTags: ["gluten-free", "high-protein", "low-carb", "keto"],
    difficulty: "easy",
    nutrition: { calories: 120, protein: 10, carbs: 4, fat: 7, fiber: 2, sodium: 480 },
    cuisine: "italian",
    season: "spring",
  },
  {
    id: "spring-caprese-bruschetta",
    title: "Spring Caprese Bruschetta",
    mealType: "sides",
    ...
    instructions: [
      ...
      "Rub warm toasts with cut garlic clove.",
      "Top with mozzarella, diced tomatoes, and basil.",
    ...
    dietaryTags: ["vegetarian"],
    difficulty: "easy",
    nutrition: { calories: 180, protein: 8, carbs: 18, fat: 9, fiber: 1, sodium: 280 },
    cuisine: "italian",
    season: "spring",
  },
];
...
const keyIngredients: Record<string, string[]> = {
  ...
  // Sauces
  "creamy-chipotle-yogurt-sauce": ["yogurt-greek-plain", "chipotle-powder"],
  "avocado-lime-crema": ["avocado", "yogurt-greek-plain"],
  "lemon-tahini-sauce": ["tahini", "lemon"],
  "cilantro-lime-yogurt-sauce": ["yogurt-greek-plain", "cilantro"],
  "tzatziki-sauce": ["yogurt-greek-plain", "cucumber"],
  "honey-sriracha-sauce": ["honey", "sriracha"],
  "garlic-herb-yogurt-sauce": ["yogurt-greek-plain", "garlic"],
  "rope-beef-sausage-egg-rolls": ["rope-beef-sausage", "egg-roll-wrappers"],
  "sweet-chili-dipping-sauce": ["rice-vinegar", "red-pepper-flakes"],
  "hot-mustard-dipping-sauce": ["mustard-yellow"],
};
...
function ingredientMatches(selectedId: string, recipeIngredient: string): boolean {
  ...
  const ingredientGroups: Record<string, string[]> = {
    chicken: ['chicken-breast', 'chicken-thighs', 'chicken-tenders', 'chicken-wings', 'chicken-drumsticks', 'ground-chicken', 'rotisserie-chicken', 'whole-chicken'],
    beef: ['ground-beef', 'ground-beef-lean', 'beef-sirloin', 'beef-ribeye', 'beef-filet', 'beef-flank', 'stew-beef', 'beef-roast', 'beef-short-ribs', 'beef-steak', 'beef-brisket'],
    pork: ['pork-chops', 'pork-loin', 'ground-pork', 'bacon', 'turkey-bacon', 'pork-tenderloin', 'pork-shoulder', 'pork-belly', 'ham', 'ham-sliced', 'pork-ribs', 'sausage-italian', 'sausage-breakfast', 'sausage-chorizo', 'chorizo'],
    fish: ['salmon-fillet', 'salmon-smoked', 'tilapia', 'cod', 'tuna-steak', 'mahi-mahi', 'halibut', 'sea-bass', 'catfish', 'trout', 'snapper'],
    shrimp: ['shrimp-raw', 'shrimp-cooked', 'shrimp-jumbo', 'raw-shrimp', 'cooked-shrimp', 'jumbo-shrimp', 'shrimp-peeled', 'cocktail-shrimp'],
    tofu: ['tofu-firm', 'tofu-extra-firm', 'tofu-silken', 'firm-tofu', 'extra-firm-tofu', 'silken-tofu', 'smoked-tofu'],
    eggs: ['eggs-large', 'eggs-extra-large', 'egg-whites', 'eggs-organic', 'large-eggs', 'extra-large-eggs', 'cage-free-eggs', 'organic-eggs'],
    milk: ['milk-whole', 'milk-2-percent', 'milk-skim', 'milk-almond', 'milk-oat', 'milk-coconut', 'whole-milk', '2-percent-milk', '1-percent-milk', 'skim-milk', 'almond-milk', 'oat-milk', 'soy-milk', 'coconut-milk-beverage', 'lactose-free-milk'],
    butter: ['butter-salted', 'butter-unsalted', 'salted-butter', 'unsalted-butter', 'european-butter', 'grass-fed-butter', 'whipped-butter'],
    cheese: ['cheese-cheddar', 'cheese-sharp-cheddar', 'cheese-mozzarella', 'cheese-fresh-mozzarella', 'cheese-parmesan', 'cheese-feta', 'cheese-swiss', 'cheese-gouda', 'cheese-brie', 'cheese-provolone', 'cheese-pepper-jack', 'cheese-ricotta', 'cheese-goat', 'cheese-mexican-blend', 'cheddar-cheese', 'sharp-cheddar', 'mozzarella', 'fresh-mozzarella', 'parmesan', 'feta-cheese', 'swiss-cheese', 'gouda', 'blue-cheese', 'brie', 'provolone', 'pepper-jack', 'american-cheese', 'cotija', 'ricotta', 'goat-cheese', 'shredded-mexican'],
    yogurt: ['yogurt-greek-plain', 'yogurt-greek-vanilla', 'yogurt-regular', 'plain-yogurt', 'greek-yogurt', 'vanilla-yogurt', 'low-fat-yogurt', 'non-fat-greek-yogurt'],
    cream: ['cream-heavy', 'cream-light', 'half-and-half', 'heavy-cream', 'heavy-whipping-cream', 'light-cream'],
    'sour-cream': ['full-fat-sour-cream', 'light-sour-cream', 'mexican-crema'],
    'cream-cheese': ['regular-cream-cheese', 'whipped-cream-cheese', 'low-fat-cream-cheese', 'flavored-cream-cheese'],
    onion: ['onion-yellow', 'onion-white', 'onion-red', 'onion-sweet', 'shallots', 'green-onions', 'yellow-onion', 'red-onion', 'white-onion', 'sweet-onion', 'green-onion'],
    garlic: ['garlic-fresh', 'garlic-minced', 'garlic-roasted', 'fresh-garlic', 'minced-garlic', 'garlic-cloves', 'elephant-garlic'],
    tomato: ['tomato-roma', 'tomato-cherry', 'tomato-grape', 'tomato-beefsteak', 'tomato-heirloom', 'roma-tomatoes', 'cherry-tomatoes', 'beefsteak-tomatoes', 'grape-tomatoes', 'heirloom-tomatoes', 'vine-tomatoes'],
    lettuce: ['lettuce-romaine', 'lettuce-iceberg', 'lettuce-butter', 'mixed-greens', 'arugula', 'romaine-lettuce', 'iceberg-lettuce', 'butter-lettuce', 'spring-mix'],
    spinach: ['spinach-baby', 'spinach-bunch', 'spinach-frozen', 'baby-spinach', 'mature-spinach', 'frozen-spinach'],
    carrot: ['carrots-whole', 'carrots-baby', 'carrots-shredded', 'whole-carrots', 'baby-carrots', 'shredded-carrots', 'rainbow-carrots'],
    'bell-pepper': ['bell-pepper-red', 'bell-pepper-green', 'bell-pepper-yellow', 'bell-pepper-orange', 'green-bell-pepper', 'red-bell-pepper', 'yellow-bell-pepper', 'orange-bell-pepper', 'mini-peppers'],
    broccoli: ['broccoli-crowns', 'broccoli-florets', 'broccoli-frozen', 'broccolini', 'frozen-broccoli'],
    zucchini: ['zucchini-green', 'zucchini-yellow', 'green-zucchini', 'yellow-squash', 'zucchini-noodles'],
    mushroom: ['mushroom-white', 'mushroom-cremini', 'mushroom-portobello', 'mushroom-shiitake', 'white-mushrooms', 'cremini-mushrooms', 'portobello-mushrooms', 'shiitake-mushrooms', 'sliced-mushrooms'],
    celery: ['celery-stalks', 'celery-hearts', 'celery-bunch', 'celery-sticks'],
    cucumber: ['cucumber-english', 'cucumber-persian', 'cucumber-regular', 'english-cucumber', 'regular-cucumber', 'persian-cucumber', 'pickling-cucumber'],
    potato: ['russet-potato', 'yukon-gold', 'red-potato', 'sweet-potato', 'fingerling-potato', 'baby-potatoes'],
    ...
    rice: ['rice-white', 'rice-brown', 'rice-jasmine', 'rice-basmati', 'white-rice', 'brown-rice', 'jasmine-rice', 'basmati-rice'],
    pasta: ['pasta-spaghetti', 'pasta-penne', 'pasta-fettuccine', 'pasta-linguine', 'pasta-rigatoni', 'pasta-lasagna', 'spaghetti', 'penne', 'fettuccine', 'linguine', 'rigatoni', 'lasagna-noodles', 'elbow-macaroni', 'angel-hair', 'farfalle', 'orzo'],
    bread: ['bread-white', 'bread-wheat', 'bread-sourdough', 'bread-baguette', 'white-bread', 'wheat-bread', 'sourdough-bread', 'baguette', 'ciabatta', 'brioche', 'rye-bread', 'pita-bread', 'naan', 'tortillas-flour', 'tortillas-corn'],
    oats: ['oats-rolled', 'oats-steel-cut', 'oats-instant', 'rolled-oats', 'steel-cut-oats', 'instant-oats', 'quick-oats'],
    flour: ['flour-all-purpose', 'flour-bread', 'flour-whole-wheat', 'all-purpose-flour', 'bread-flour', 'whole-wheat-flour', 'cake-flour', 'self-rising-flour'],
    quinoa: ['quinoa-white', 'quinoa-red', 'white-quinoa', 'red-quinoa', 'tri-color-quinoa'],
    beans: ['beans-black', 'beans-pinto', 'beans-kidney', 'beans-cannellini', 'beans-refried', 'black-beans', 'pinto-beans', 'kidney-beans', 'cannellini-beans', 'refried-beans', 'chickpeas', 'navy-beans', 'great-northern-beans'],
    tomatoes: ['tomatoes-diced', 'tomatoes-crushed', 'tomatoes-sauce', 'tomatoes-paste', 'diced-tomatoes', 'crushed-tomatoes', 'tomato-sauce', 'tomato-paste'],
    tuna: ['tuna-white', 'tuna-chunk'],
    'coconut-milk': ['coconut-milk-full', 'coconut-milk-light', 'full-fat-coconut-milk', 'light-coconut-milk'],
    olives: ['olives-black', 'olives-kalamata', 'olives-green', 'black-olives', 'kalamata-olives', 'green-olives'],
    ...
    'olive-oil': ['olive-oil-evoo', 'olive-oil-light', 'extra-virgin-olive-oil', 'light-olive-oil'],
    'vegetable-oil': ['vegetable-oil', 'canola-oil'],
    salt: ['salt-kosher', 'salt-sea', 'salt-table', 'kosher-salt', 'sea-salt', 'table-salt', 'himalayan-salt', 'flaky-salt'],
    pepper: ['pepper-ground', 'pepper-whole', 'pepper-white', 'black-pepper', 'white-pepper', 'whole-peppercorns'],
    paprika: ['paprika-sweet', 'paprika-smoked', 'paprika-hot', 'sweet-paprika', 'smoked-paprika', 'hot-paprika'],
    cumin: ['cumin-ground', 'cumin-seeds', 'ground-cumin', 'cumin-seed'],
    cinnamon: ['cinnamon-ground', 'cinnamon-sticks', 'ground-cinnamon'],
    ginger: ['ginger-ground', 'ginger-fresh', 'fresh-ginger', 'ground-ginger'],
    basil: ['basil-dried', 'basil-fresh', 'fresh-basil', 'dried-basil'],
    oregano: ['oregano-dried', 'oregano-fresh', 'fresh-oregano', 'dried-oregano'],
    thyme: ['thyme-dried', 'thyme-fresh', 'fresh-thyme', 'dried-thyme'],
    rosemary: ['rosemary-dried', 'rosemary-fresh', 'fresh-rosemary', 'dried-rosemary'],
    parsley: ['parsley-dried', 'parsley-fresh', 'fresh-parsley', 'dried-parsley', 'flat-leaf-parsley', 'curly-parsley'],
    'soy-sauce': ['soy-sauce', 'soy-sauce-low-sodium', 'low-sodium-soy-sauce'],
    mustard: ['mustard-yellow', 'mustard-dijon', 'mustard-whole-grain', 'yellow-mustard', 'dijon-mustard', 'whole-grain-mustard'],
    corn: ['corn-on-cob', 'frozen-corn', 'canned-corn'],
    asparagus: ['green-asparagus', 'white-asparagus', 'thin-asparagus'],
    cabbage: ['green-cabbage', 'red-cabbage', 'napa-cabbage', 'coleslaw-mix'],
    kale: ['curly-kale', 'lacinato-kale', 'baby-kale'],
    cauliflower: ['cauliflower-head', 'cauliflower-florets', 'cauliflower-rice'],
    'green-beans': ['fresh-green-beans', 'french-green-beans', 'frozen-green-beans', 'canned-green-beans'],
    peas: ['frozen-peas', 'snow-peas', 'sugar-snap-peas', 'canned-peas'],
  };
...
export function getRecipesForIngredients(selectedIngredients: string[]): Recipe[] {
  ...
  return sampleRecipes
    ...
    .filter(recipe => {
      // Dynamic threshold: be more lenient with fewer selected ingredients
      const minThreshold = selectedIngredients.length <= 2 ? 0.1 
        : selectedIngredients.length <= 4 ? 0.2 
        : 0.4;
      // Also require at least 1 matched ingredient
      return recipe.matchedIngredients.length >= 1 && recipe.matchScore >= minThreshold && recipe.hasAllKeyIngredients;
    })
