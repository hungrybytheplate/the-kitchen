...
import { Search, ShoppingCart, Clock, Wine } from "lucide-react";
...
export function DrinkLookup({ onAddToShopping }: DrinkLookupProps) {
  ...
  const handleAddAllToShopping = (drink: Drink) => {
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div>
                      ...
                      <h4 className="font-semibold">{drink.title}</h4>
                  ...
                  <Button
                    ...
                    onClick={() => handleAddAllToShopping(drink)}
                  >
